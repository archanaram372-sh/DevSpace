...
import { Users, ChevronRight, Server, Shield, Monitor, Sparkles } from "lucide-react";
import { useNavigate } from "react-router-dom";
import "./TeamsSelectionPage.css";

// Hardcoded initial teams based on requirement "we def need team a b c d"
const MOCK_TEAMS = [
      ...
      <main className="teams-main">
        ...
        <div className="teams-grid">
          {MOCK_TEAMS.map((team) => (
            ...
            >
              <div className="team-icon-wrapper" style={{ backgroundColor: `${team.color}20`, color: team.color }}>
                {team.icon}
              </div>
